            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="form-group">
                        <label>Assunto</label>
                        <input type="text" class="form-control" ng-model="txtDesc" id="txtDesc">
                    </div>
                    <div class="form-group">
                        <label>Detalhes</label>
                        <textarea class="form-control" ng-model="txtObs" id="txtObs" rows="10"></textarea>
                    </div>
                    <div class="form-group">
                        <button class="btn btn-primary" ng-click="salvarTicket()">Salvar</button>
                    </div>
                </div>
            </div>
        </div>
