...
<body ng-controller="Main as mn" ng-init="getStatistics()">
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" ng-init="getUsuario()">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><span>SOS</span>Fashion</a>
            <ul class="user-menu">
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    <ul class="nav menu">
        ...
        <li class="active"><a href="home.php">
                ...
                Dashboard</a></li>
        <li><a href="#"><i class="glyph fa fa-user" aria-hidden="true"></i>Usuários</a></li>
        <li><a href="#"><i class="glyph fa fa-bars" aria-hidden="true"></i>Enquetes</a></li>
        <li><a href="#"><i class="glyph fa fa-line-chart" aria-hidden="true"></i>Ranking de Usuários</a></li>
        <li><a href="#"><i class="glyph fa fa-bullhorn" aria-hidden="true"></i>Banners</a></li>
        <li><a href="#"><i class="glyph fa fa-pie-chart" aria-hidden="true"></i>Relatórios</a></li>
