...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row" ng-init="getTickets()">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <table id="TicketTable" class="table table-hover">
                        <thead>
                        <tr>
                            <th data-field="state" data-checkbox="true" >Nº Ticket</th>
                            <th data-field="id" data-sortable="true">Assunto</th>
                            <th data-field="id" data-sortable="true">Status</th>
                            <th data-field="name"  data-sortable="true">Data de Cadastro</th>
                            <th data-field="price" data-sortable="true">Data de Atualização</th>
                        </tr>
                        </thead>
                        <tbody>
                            <tr ng-repeat="item in dadosTicket" ng-click="updateTicket(item.id_ticket)">
                                <td>{{item.id_ticket}}</td>
                                <td>{{item.desc_ticket}}</td>
                                <td>{{getStatus(item.status_ticket)}}</td>
                                <td>{{formatDate(item.datcad_ticket)}}</td>
                                <td>{{formatDate(item.datatu_ticket)}}</td>
